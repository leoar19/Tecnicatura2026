...
Abrimos la terminal de Git Bash en Windows o la terminal de Ubuntu, tambien la terminal de Mac, y comenzamos con los siguientes comandos y creación de directorios<br>
...
cd .. # Volvemos a la carpeta anterior
cd /mnt/c # Cambia al disco C
cd ~ #Vamos a la raíz
mkdir Tecnicatura #Recordar que en window las mayúsculas no tienen relevancia, pero si en Linux
cd tecnicatura # Entramos a la carpeta tecnicatura
mkdir Python # Creamos carpeta Python
mkdir Java # Creamos carpeta Java
mkdir JavaScript # Creamos carpeta JavaScript
```

Revisar y ejecutar cada comando, hacerlo como práctica.<br>

# Clase 2 Git Bash

 Abrir git bash en Windows o la terminal de Linux o de Mac: al abrir Git Bash hacerlo como administrador<br>

```sh
touch vacio.txt #Crea un archivo con su extensión: ESCRIBIR DENTRO
...
```sh
cd tecnicatura # Entramos a la carpeta tecnicatura
mkdir class-git # Creamos la carpeta class-git
...
```sh
git config --global user.name "Ariel Betancud" # Configura el nombre de usuario global
...
git add . # Prepara todo los cambios para el commit
git commit -m "Mi segundo commit" # Crea un commit con los cambios agregados
...
```sh
git status # Muestra qué archivos fueron modificados, agregados o están listos para hacer commit
git add . # Ingresamos archivos al área de preparación
git status # Muestra qué archivos fueron modificados, agregados o están listos para hacer commit
git commit -m "Cargamos el README dentro del directorio class-git" # Crea un commit con los cambios y archivos agregados
git status # Muestra qué archivos fueron modificados, agregados o están listos para hacer commit
...
```sh
cd tecnicatura # Entramos en la carpeta tecnicatura
cd class-git # Entramos en la carpeta git
ls # Muestra los archivos y carpetas del directorio actual
touch historia.txt # Crea un archivo vacío llamado historia.txt
code . # Abre VSC en la ubicación actual
#Modificamos el archivo historia.txt colocando lo siguiente: Bienvenido     mi nombre es Ariel (coloca tu nombre)
ctrl + s # Guardamos los cambios en el archivo historia.txt
git status # Muestra qué archivos fueron modificados, agregados o están listos para hacer commit
git add . # Ingresamos archivos al área de preparación
git status # Muestra los archivos agregados y listos para hacer commit
...
ctrl + s # Guardamos cambios en el archivo historia.txt
git add . # Ingresamos archivos al área de preparación
git commit # Crea un commit y abre el editor para escribir el mensaje del commit
...
Tienes una carpeta donde están los archivos de tu proyecto o un directorio y allí tenemos el archivo historia.txt, cuando entramos por consola a ese archivo y creamos el git init, se crea un área en memoria ram que se llama staging, y el otro es el repositorio esta es la carpeta .git donde estarán todos los cambios al final del proyecto.<br>
...
> IMAGEN-1: No cargar imágenes, son archivos de tipo binarios.<br>

## ¿Qué es Gitflow? 
Gitflow es un modelo alternativo de creación de ramas en Git en el que se utilizan ramas de función y varias ramas principales. Fue Vincent Driessen en nvie quien lo publicó por primera vez y quien lo popularizó.<br>

## ¿Qué es branch (rama) y cómo funciona un merge en git?<br>

Tenemos una rama llamada master y es donde están los cambios de nuestros archivos, con cada commit creamos una nueva versión<br>
...
Esta es una metodología estricta pero que da lugar a diferentes interpretaciones o diferentes formas de llevarla en cada equipo, por lo que en algunos casos, algún experto puede permitirse no seguir esa norma, pero son casos muy específicos y siempre de personas de confianza.<br>

En las ramas auxiliares tenemos la rama Feature, la rama Release y la Rama Hotfix, que puede instanciarse todas las veces que se consideren necesarias:<br>

La rama Feature, para nuevas características, nuevos requisitos o nuevas historias de usuario.<br>
La rama Release, para estandarizar o cortar una serie de código que ha estado desarrollándose en la rama Develop, se saca una rama de este tipo, se mergea y ahí se depura.<br>
La rama Hotfix, que habitualmente se utiliza para código para depurar el código que venga de producción, por haberse detectado un defecto crítico en producción que deba resolverse, al que se le va a hacer una Release puntual para corregirlo.<br>
Estas ramas tienen un principio y un fin, ya que son ramas que se mergean con las ramas Master y Develop y desaparecen.<br>

Podemos tener tantas ramas como queramos, tantos repositorios como queramos, lo más importante es saber cuando hacemos un merge, porque es posible que hayan archivos que rompan otros archivos, a esto se lo llama conflicto o bug.<br>

Hoy ha sido un poco de teoría, repaso de todo lo que les dió la profe Naty.<br>
...
ls # Muestra los archivos y las carpetas del directorio actual
touch historia.txt # Crea un archivo vacío llamado historia.txt
cd .. # Volvemos a la carpeta anterior
code . #Agregamos cambios en el archivo historia.txt
...
git show # Muestra el último commit, incluyendo autor, fecha, mensaje y cambios realizados
...
git add . # Añadimos los cambios para commitear
git commit -m "Agregamos datos de estudios en historia.txt" # Volvemos a commitear
...
git commit -m "Commiteamos lo último de hoy" # Crea un commit con los cambios y archivos agregados
...
ctrl + s # Guardamos los cambios en historia.txt
...
git commit -am "cambio en la última línea del historia.txt" # Agrega los archivos modificados y crea un commit con el mensaje indicado
...
git commit -am "Reemplazo de una versión por otra de la historia" # Agrega los archivos modificados y crea un commit con el mensaje indicado
git log # Muestra el historial de commits
...
git branch tuNombre # Crea una nueva rama llamada "tuNombre"
git branch hotfix # Crea una nueva rama llamada "hotfix"
git branch #Vemos las ramas que tenemos
git branch -d cambios #Borramos la rama, si no se borra utilizar
git branch -D cambios # Elimina la rama llamada "cambios" de forma forzada
cd .. # Volvemos a la carpeta anterior
cd .. # Volvemos a la carpeta anterior
```
...
git add reset_file.txt # Añadimos al área de preparación el archivo

git add . # Añadimos todos los cambios y modificaciones al área de preparación

git commit -m"Iniciando el primer commit" # Crea un commit con los cambios agregados
...
En resumen, para evitar problemas en el trabajo, es valioso entender las implicaciones y riesgos de cada comando y elegir el enfoque adecuado según las necesidades y el flujo de trabajo del proyecto.
...
git log --graph --oneline --decorate --all # Muestra el historial de commits de forma resumida, incluyendo ramas y un gráfico de su estructura

git log -3 #Limitamos el número de commits.

git log --after=“2018-1-2” # Muestra los commits realizados después del 2 de enero de 2018

git log --after=“today” # Muestra los commits realizados desde hoy
...
> Cómo funcionan las ramas en GIT <br>
...
Abrir terminal en ubuntu o abrir git bash como administrador en windows:
...
esc # Para salir del editor de texto y seguimos:
...
git commit -am "Solucionado el conflicto 2" # Solucionamos el segundo conflicto y hacemos el commit
...
git commit -am "Para guardar estos cambios en el README.md" # Agrega automáticamente los archivos modificados y crea un commit con el mensaje indicado

git checkout segunda # Cambio de rama a segunda

git merge master #Traemos todos los cambios

git commit -am "Cargamos esto ahora" #vamos a master y mergeamos

git checkout master # Cambio de rama a master
...
```sh
git merge --abort # Cancela una operación de merge en curso y vuelve al estado anterior
```

> Conflictos en repositorios remotos

Al trabajar con otras personas, es necesario utilizar un repositorio remoto.<br>
­
...
```sh
git clone enlace-ssh # Copia un repositorio remoto en la computadora usando una dirección SSH
git fetch # Descarga los cambios del repositorio remoto sin fusionarlos con la rama actual
git push origin master # Envía los commits de la rama master al repositorio remoto llamado origin
git merge # Fusiona los cambios de otra rama con la rama actual
git pull origin master # Descarga y fusiona los cambios de la rama master del repositorio remoto origin
git commit -am"Este es un commit rápido" # Agrega los archivos modificados y crea un commit con el mensaje indicado
...
git add . # Añadimos los cambios al área de preparación
git commit -m"Cambios en el archivo de trabajo" # Crea un commit con los cambios hechos
git push origin second # Sube la rama second al repositorio remoto
git checkout master # Entramos a la rama master
git merge second #Mergeamos los cambios a la rama master
git push origin master # Envía los commits de la rama master al repositorio remoto
```
...
git commit -m"Aregando cambios nuevos al archivo de trabajo" # Crea un commit con los cambios agregados al staging
...
git commit -am "Modifique el html y el color del texto" es un ejemplo # Agrega automáticamente los archivos modificados y crea un commit con el mensaje indicado

git checkout master #Modificamos el html, ponemos código y ponemos texto blue

ctrl + s #Guardamos los cambios

git commit -am "Agregue información, cambie el código y puse todo el texto azul" # Agrega automáticamente los archivos modificados y crea un commit con el mensaje indicado
...
git commit -am "Solución de conflictos al mergear las ramas" # Agrega automáticamente los archivos modificados y crea un commit con el mensaje indicado
...
```sh
Host * # Aplica la configuración a todas las conexiones SSH

AddKeysToAgent yes # Agrega automáticamente las claves SSH al agente SSH

UseKeychain yes # Guarda y recupera la clave SSH desde el llavero del sistema (macOS)

IdentityFile ruta-donde-guardaste-tu-llave-privada # Indica la ubicación de la clave privada que SSH debe utilizar
```

Añadir tu llave SSH al “servidor” de llaves SSH de tu computadora (en caso de error puedes ejecutar este mismo comando pero sin el argumento -K):

```sh
ssh-add -K ruta-donde-guardaste-tu-llave-privada # Agrega la clave privada al llavero del sistema para no ingresar la contraseña cada vez
```
